...
jQuery(function ($) {
    ...
    $window.on("scroll", function () {
        if ($window.scrollTop() > amountScrolled) {
            ...
            let a =$("a.btn-circle-selected");
            a.removeClass("btn-circle-selected");
            a.addClass("btn-circle-selected-scroll");
        } else {
...
function sendMsg(e) {
    ...
    const clientName = document.querySelector('.name'),
        ...
        servicesSelect = document.querySelector('.servicesSelect'),
        msg = document.querySelector('.msg');

    var templateParams = {
        name: clientName.value,
        notes: servicesSelect.value,
        contact: email.value,
        message: msg.value

    };

    emailjs.send('service_pkdcycg', 'template_lm2xz4q', templateParams)
...
onclick="setSelect('Marítimo')"

function setSelect(service){
